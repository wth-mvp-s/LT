...
- [ ] It's a programming language used for developing software.
...
- [ ] It's the process of balancing the load on a single server.
- [ ] It's the process of balancing the load on a development team.
- [ ] None of the above
...
- [ ] It's a process where data is permanently stored.
- [ ] It's a process where data is deleted when it's no longer needed.
- [ ] None of the above
...
- [ ] It's a review of the sprint in the middle of the sprint.
- [ ] It's a review of the sprint at the beginning of the sprint.
- [ ] None of the above
