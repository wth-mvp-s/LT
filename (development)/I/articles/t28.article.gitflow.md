...
##  Daily Scrum or daily standup
    promote communication, transparency, and quick problem-solving
        Each team member discusses
            - what they did yesterday, 
            - what they plan to do today, and 
            - any blockers or issues they are facing.

As a tech lead, while it might seem like you don't need to know about every single struggle, the purpose of this daily check-in is to facilitate problem-solving, identify any potential roadblocks early on, and ensure that the team is collaboratively moving towards the sprint goal. It's not just for reporting tasks, but it is indeed a venue for raising questions, discussing technical issues, and better understanding the process. It promotes a culture of shared responsibility and can often lead to more efficient solutions or innovative ideas.