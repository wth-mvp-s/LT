...
- [ ] User3: Build Administrators
- [x] User3: Contributors
- [ ] User3: Project Administrators
- [ ] User3: Readers
...
- [ ] 
`git checkout main
`git restore --patch main~3 App.exe.config

- [ ] 
`git branch main
`git restore --merge main~3 App.exe.config
