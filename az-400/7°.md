...
- [x] enable automatic tuning on a single database, navigate to the database in the Azure portal and select Automatic tuning. Select the automatic tuning options you want to enable and select Apply.
