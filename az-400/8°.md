...
- [x] QA: Configure a gate in the pre-deployment conditions.
- [ ] QA: Configure a trigger in the pre-deployment conditions
- [ ] QA: Configure the Deployment queue settings in the pre-deployment conditions
...
- [x] Threshold value set to 80% / Aggregation granularity (Period) set to 15minutes
- [ ] Threshold value set to 50% / Aggregation granularity (Period) set to 5minutes
- [ ] Threshold value set to 80% / Aggregation granularity (Period) set to 1minute
