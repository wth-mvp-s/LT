...
- [ ] Set the Express Route gateway type to: Ultra Performance (ERGW3AZ)
...
- [ ] To minimize latency of traffic to Vnet2: Configure gateway transit for the peering between Vnet1 and Vnet2
...
- [ ] To implement automatic DNS name registration in cloud.litwareinc.com: Create virtual network links
...
- [ ] To implement name resolution of the cloud.litwareinc.com DNS records from the on-premises locations: Deploy an Azure virtual machine configured as a DNS server to Vnet1
