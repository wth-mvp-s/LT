...
[//]here end 1st file in new 10 md files folder
...
- [x] VM2 can communicate with (answer choice): VM1 and VM3 only
- [ ] VM2 can communicate with (answer choice): the on-premises datacenter and VM3 only 
- [ ] VM2 can communicate with (answer choice): the on-premises datacenter, VM1, and VM3 only
